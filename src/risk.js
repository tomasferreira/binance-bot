...
export function calculatePositionSize ({
  ...
  logger.debug('calculatePositionSize: input', {
    balanceQuote,
    entryPrice,
    stopLossPrice,
    riskPerTrade,
  ...
  logger.debug('calculatePositionSize: result', { riskAmount, stopDistance, feePerUnit, lossPerUnit, positionSizeBase, rounded })
  return rounded
}
